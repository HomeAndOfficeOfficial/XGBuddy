...
enum class EffectParameter(
    ...
    EQ_LOW_GAIN(R.string.fxp_eq_low_gain, 52, 76, DataFormatUtil.decibelFormatter, false),
    EQ_HIGH_FREQ(R.string.fxp_eq_high_freq, 28, 58, DataFormatUtil.eqFreqFormatter, false),
    EQ_HIGH_GAIN(R.string.fxp_eq_high_gain, 52, 76, DataFormatUtil.decibelFormatter, false),
    ...
    LR_DELAY(R.string.fxp_lr_delay, 1, 3550, DataFormatUtil.millisecondFormatter, false),
    RL_DELAY(R.string.fxp_rl_delay, 1, 3550, DataFormatUtil.millisecondFormatter, false),
    ...
    EQ_MID_GAIN(R.string.fxp_eq_mid_gain, 52, 76, DataFormatUtil.decibelFormatter, false),
